    ...
    <form className="form" method="POST" id="seofForm" onSubmit={handleSubmit}>
      <div className="row">
        <div className="col-md-6">
          ...
          <div className="form__group mb-4">
            <label htmlFor="" className="form-label">
              No. of Blogs <span>*</span>
            </label>
            <select
              name="number_of_blogs"
              className="form-select"
              value={formData.number_of_blogs}
              onChange={(e) => handleChange("number_of_blogs")(e.target.value)}
              required
            >
              <option value="">Select no. of Blogs</option>
        ...
        <div className="col-md-6">
          ...
          <div className="form__group mb-4">
            ...
            <input
              type="number"
              className="form-control"
              value={formData.number_of_keywords}
              onChange={(e) =>
                handleChange("number_of_keywords")(e.target.value)
              }
